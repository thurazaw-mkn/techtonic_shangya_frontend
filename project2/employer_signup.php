...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = companies_signup($name, $industry, $email, $description, $head_office_address);
...
<body>
  ...
  <section class="hero">
    <section class="hero-content fade-in">
      <form method="POST" action="employer_signup.php" style="display: flex; flex-direction: column; gap: 16px; max-width: 320px; margin: 0 auto; background: #fff; padding: 32px 24px; border-radius: 12px; box-shadow: 0 2px 16px rgba(0,0,0,0.08);">
