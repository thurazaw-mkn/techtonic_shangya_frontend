...
<head>
    ...
    <title>SHANGYA - Admin Companies</title>
    ...
    <header class="navbar">
        <section class="container nav-content">
            ...
            <nav class="nav-links">
                ...
                <a href="./admin_companies.php" class="active">Companies</a>
                ...
                <?php if ($admins && count($admins) > 0): ?>
                    <?php foreach ($admins as $admin): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($admin['industry']); ?></td>
                            <td><?php echo htmlspecialchars($admin['description']); ?></td>
                            <td><?php echo htmlspecialchars($admin['head_office_address']); ?></td>
                            <td class="admin-table-actions">
                                <a href="admin_update.php?username=<?php echo urlencode($admin['id']); ?>" title="Edit"><i class="fas fa-edit"></i> Edit</a>
                                <a href="admin_admins.php?delete=<?php echo urlencode($admin['id']); ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this admin?');"><i class="fas fa-trash"></i> Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
